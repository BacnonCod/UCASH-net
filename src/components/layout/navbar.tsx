    ...
    <nav className="bg-ucash-dark w-full px-4 md:px-8 py-4 flex items-center justify-between">
      <div className="flex items-center">
        ...
        {isLoggedIn && (
          <div className="ml-8 hidden md:block">
            <p className="text-white text-lg font-medium">Welcome back, {userName}</p>
            <p className="text-gray-300 text-sm">Let's take a detailed look at your financial situation today</p>
          </div>
        )}
      </div>
      ...
      {!isLoggedIn ? (
        <div className="flex items-center space-x-6">
          ...
          <Button asChild className="bg-white text-ucash-dark hover:bg-gray-200 font-medium rounded-sm">
