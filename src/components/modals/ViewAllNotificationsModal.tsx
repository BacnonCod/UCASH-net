...
import { CheckCircle, CreditCard, Bell, ShieldAlert, Clock, Filter, Trash2 } from 'lucide-react';
...
const ViewAllNotificationsModal: React.FC<ViewAllNotificationsModalProps> = ({ open, onOpenChange }) => {
  const notifications = [
    {
      id: 1,
    ...
    },
    {
      id: 6,
      title: 'Promotion',
      message: 'Special Offer: Get 2% cashback on all transactions this weekend!',
      time: '1 week ago',
      type: 'info',
      read: true
    },
    {
      ...
      message: 'Your account has been successfully verified. Enjoy full features!',
      time: '2 weeks ago',
      type: 'success',
      read: true
    },
