...
import { CheckCircle, Clock, Circle, Search, Download, Filter } from 'lucide-react';
...
const TransactionHistoryModal: React.FC<TransactionHistoryModalProps> = ({ open, onOpenChange }) => {
