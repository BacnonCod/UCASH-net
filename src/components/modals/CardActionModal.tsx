...
import { Clock, CheckCircle, ArrowUpRight, ArrowDownRight, CreditCard, PlusCircle } from 'lucide-react';
...
const CardActionModal: React.FC<CardActionModalProps> = ({ open, onOpenChange, action }) => {
      ...
      <DialogContent className="sm:max-w-[600px]">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div
                  className={`flex items-center p-3 border rounded-lg cursor-pointer ${
                    paymentMethod === 'bank' ? 'border-ucash-dark bg-gray-50' : 'border-gray-200'
                  }`}
                ...
                <div
                  className={`flex items-center p-3 border rounded-lg cursor-pointer ${
                    paymentMethod === 'card' ? 'border-ucash-dark bg-gray-50' : 'border-gray-200'
                  }`}
        ...
        {action === 'topup' && (
          <DialogFooter>
            ...
            <Button onClick={handleTopup} className="bg-ucash-dark">Top Up</Button>
          </DialogFooter>
        )}
      </DialogContent>
    </Dialog>
